...
public class MainDish extends Item{
	...
	public MainDish(Restaurant restaurant, String itemname, ItemType itemtype, double itemprice, boolean gluten_free) {
		super(restaurant, itemname, itemtype, itemprice, gluten_free);
		// TODO Auto-generated constructor stub
	}

	public MainDish(Restaurant restaurant, String itemname, ItemType itemtype, double itemprice, RegimeType regimetype,
			boolean gluten_free) {
		super(restaurant, itemname, itemtype, itemprice, regimetype, gluten_free);
		// TODO Auto-generated constructor stub
	}

	public MainDish(Restaurant restaurant, String itemname, ItemType itemtype, double itemprice,
