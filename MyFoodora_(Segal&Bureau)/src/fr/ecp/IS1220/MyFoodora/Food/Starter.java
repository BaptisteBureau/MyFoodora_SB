...
public class Starter extends Item{
	...
	public Starter(Restaurant restaurant, String itemname, ItemType itemtype, double itemprice, boolean gluten_free) {
		super(restaurant, itemname, itemtype, itemprice, gluten_free);
		// TODO Auto-generated constructor stub
	}

	public Starter(Restaurant restaurant, String itemname, ItemType itemtype, double itemprice, RegimeType regimetype,
			boolean gluten_free) {
	...
	public Starter(Restaurant restaurant, String itemname, ItemType itemtype, double itemprice) {
